	...
	wayland.windowManager.hyprland = {
		...
		settings = {
			...
			bind = [
				...
				#Cliphist rofi
				"$mainMod, V, exec, cliphist list | rofi -dmenu -theme ~/.config/rofi/cliphist.rasi| cliphist decode | wl-copy"
				"$mainMod SHIFT, V, exec, cliphist list | rofi -dmenu -theme ~/.config/rofi/cliphist.rasi | cliphist delete"
