...
ls.add_snippets('tex', {
	...
	s({ trig = "lar", snippetType = "autosnippet", priority = 10 }, t("\\longleftarrow "), { condition = tex.in_mathzone }),
	...
	s({ trig = "==<", snippetType = "autosnippet", priority = 75 }, t("\\Longleftarrow "),{ condition = tex.in_mathzone }),
	s({ trig = "the", snippetType = "autosnippet", priority = 75 }, t("\\Longrightarrow "), {condition = tex.in_mathzone}),
	s({ trig = "==>", snippetType = "autosnippet", priority = 75 }, t("\\Longrightarrow "),{ condition = tex.in_mathzone }),
	...
	s({ trig = "bk", dscr = "Braket notation" }, fmta([[\braket{<>}{<>}]], { i(1), i(2) }), {condition = tex.in_mathzone}),
	s({ trig = "kb", dscr = "ketbra notation" }, fmta([[\ketbra{<>}{<>}]], { i(1), i(2) }), { condition = tex.in_mathzone}),
