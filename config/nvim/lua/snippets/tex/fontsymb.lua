...
ls.add_snippets("tex", {
	...
	s({ trig = "vv", wordTrig = false, snippetType = "autosnippet" }, t("\\vee"), { condition = tex.in_mathzone }),
	s({ trig = "ww", wordTrig = false, snippetType = "autosnippet" }, t("\\wedge"), { condition = tex.in_mathzone }),
	s({ trig = "prp", wordTrig = false, snippetType = "autosnippet" }, t("\\propto"), { condition = tex.in_mathzone }),
	...
	postfix(
		{ trig = "vb", match_pattern = [[[\\%w%.%_%-%"%']+$]], dscr = "\\vb{}", snippetType = "autosnippet" },
		{ l("\\vb{" .. l.POSTFIX_MATCH .. "}") },
		{ condition = tex.in_mathzone }
	),
	s(
	...
	postfix({
		...
		snippetType = "autosnippet",
		dscr = "Display '\\tilde{}'",
	}, { l("\\tilde{" .. l.POSTFIX_MATCH .. "}") }, { condition = tex.in_mathzone }),
	postfix({
		trig = "udl",
		match_pattern = [[[\\%w%.%_%-%"%']+$]],
		snippetType = "autosnippet",
	...
	postfix({
		...
		match_pattern = [[[\\%w%.%_%-%"%']+$]],
		snippetType = "autosnippet",
	}, { l("\\mathrm{" .. l.POSTFIX_MATCH .. "}") }, { condition = tex.in_mathzone }),
	postfix({
		trig = "bb",
		match_pattern = [[[\\%w%.%_%-%"%']+$]],
	...
	s(
		{ trig = "obk", dscr = "Operator braket", snippetType = "autosnippet" },
		fmta([[\bra{<>}<>\ket{<>}]], { i(1, " "), i(2, " "), i(3, " ") }),
		{
			condition = tex.in_mathzone,
		}
	),
	s(
		{ trig = "bk", dscr = "Braket notation", snippetType = "autosnippet" },
		fmta([[\braket{<>}{<>}]], { i(1, " "), i(2, " ") }),
		{
			condition = tex.in_mathzone,
		}
	...
	s(
		{ trig = "kb", dscr = "ketbra notation", snippetType = "autosnippet" },
		fmta([[\ketbra{<>}{<>}]], { i(1, " "), i(2, " ") }),
		{ condition = tex.in_mathzone }
	),
	s(
