...
LATEX_SCRIPT = get_relative_path("../scripts/quick-latex.sh")
TTYPER_SCRIPT = get_relative_path("../scripts/ttyper.sh")
...
# Tooltips
tooltip_latex = "<b>LaTeX</b>"
tooltip_ttyper = "<b>Ttyper</b>"
## Screenshot
...
class Toolbox(Box):
    def __init__(self, **kwargs):
        ...
        self.btn_latex = Button(
            name="toolbox-button",
            tooltip_markup=tooltip_latex,
            child=Label(name="button-label", markup=icons.latex),
            on_clicked=self.latex,
            h_expand=False,
            v_expand=False,
            h_align="center",
            v_align="center",
        ...
        self.btn_ttyper = Button(
            name="toolbox-button",
            tooltip_markup=tooltip_ttyper,
            child=Label(name="button-label", markup=icons.ttyper),
            on_clicked=self.ttyper,
            h_expand=False,
            v_expand=False,
            h_align="center",
            v_align="center",
    ...
    def latex(self, *args):
        exec_shell_command_async(f"bash {LATEX_SCRIPT} s")
        self.close_menu()

    def ttyper(self, *args):
        exec_shell_command_async(f"bash {TTYPER_SCRIPT} s")
        self.close_menu()
