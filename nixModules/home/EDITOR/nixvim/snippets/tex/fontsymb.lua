...
ls.add_snippets('tex', {
	...
	s({ trig = ",S", snippetType = "autosnippet", priority = 10 }, t("\\Sigma"), { condition = tex.in_mathzone }),
	s({ trig = ",ta", snippetType = "autosnippet", priority = 10 }, t("\\tau"), { condition = tex.in_mathzone }),
	s({ trig = ",u", snippetType = "autosnippet", priority = 10 }, t("\\upsilon"), { condition = tex.in_mathzone }),
	s({ trig = ",U", snippetType = "autosnippet", priority = 10 }, t("\\upsilon"), { condition = tex.in_mathzone }),
	s({ trig = ",th", snippetType = "autosnippet", priority = 10 }, t("\\theta"), { condition = tex.in_mathzone }),
	...
	s({ trig = "rar", snippetType = "autosnippet", priority = 10 }, t("\\longrightarrow"),
	...
	s({ trig = "==<", snippetType = "autosnippet", priority = 75 }, t("\\Longleftarrow"),
		{ condition = tex.in_mathzone }),
	s({ trig = "the", snippetType = "autosnippet", priority = 75 }, t("\\Longrightarrow"), {
		condition = tex
			.in_mathzone
	}),
	s({ trig = "==>", snippetType = "autosnippet", priority = 75 }, t("\\Longrightarrow"),
	...
	s({ trig = "vec", dscr = "\\vec{}", snippetType = "autosnippet" }, fmta([[\vec{<>}]], { i(1) }),
		{ condition = tex.in_mathzone }),
	s({ trig = "seq", dscr = "Sequence", snippetType = "autosnippet" },
		fmta([[(<>_{<>})_{<>\in <>}]], { i(1), i(2), rep(2), i(3) }), { condition = tex.in_mathzone }),
	s({ trig = "emp", dscr = "Display '\\emph{}'" }, fmta([[\emph{<>}]], { i(1) })),
	s({ trig = "fam", dscr = "Family of sets", snippetType = "autosnippet" },
		fmta([[\{<>_{<>}\}_{<>\in <>}]], { i(1), i(2), rep(2), i(3) }), { condition = tex.in_mathzone }),
	s({ trig = "bar", snippetType = "autosnippet", dscr = "Display '\\underline{}'" }, fmta([[\overline{<>}]], { i(1) }),
		{ condition = tex.in_mathzone }),
	s({ trig = "hat", snippetType = "autosnippet", dscr = "Display '\\hat{}'" }, fmta([[\hat{<>}]], { i(1) }),
		{ condition = tex.in_mathzone }),
	...
	s({ trig = "()", dscr = "'\\left( \\right)'", snippetType = "autosnippet" }, { t("\\left("), i(1, " "), t("\\right)"), },
		{ condition = tex.in_mathzone }),
	s({ trig = "lr", dscr = "'\\left( \\right)" }, fmta([[\left(<>\right)]], { i(1, " ") }),
		{ condition = tex.in_mathzone }),
	s({ trig = "lr|", dscr = "'\\left| \\right|", snippetType = "autosnippet" }, fmta([[\left|<>\right|]], { i(1, " ") }),
		{ condition = tex.in_mathzone }),
	s({ trig = "lr{", dscr = "'\\left{ \\right}", snippetType = "autosnippet" },
		fmta([[\left\{<>\right\}]], { i(1, " ") }),
		{ condition = tex.in_mathzone }),
	s({ trig = "lrB", dscr = "'\\left{ \\right}", snippetType = "autosnippet" },
		fmta([[\left\{<>\right\}]], { i(1, " ") }),
		{ condition = tex.in_mathzone }),
	s({ trig = "lrb", dscr = "'\\left[ \\right]", snippetType = "autosnippet" },
		{ t('\\left['), i(1, " "), t('\\right]') },
		{ condition = tex.in_mathzone }),
	s({ trig = "lra", dscr = "'\\langle \\rangle'", snippetType = "autosnippet" },
	...
	s({ trig = "sin", dscr = "Sin function", snippetType = "autosnippet" }, { t("\\sin") },
		{ condition = tex.in_mathzone }),
	s({ trig = "cos", dscr = "Cos function", snippetType = "autosnippet" }, { t("\\cos") },
		{ condition = tex.in_mathzone }),
	s({ trig = "tan", dscr = "Tan function", snippetType = "autosnippet" }, { t("\\tan") },
		{ condition = tex.in_mathzone }),
	s({ trig = "cot", dscr = "Cot function", snippetType = "autosnippet" }, { t("\\cot") },
		{ condition = tex.in_mathzone }),
	s({ trig = "sec", dscr = "Sec function", snippetType = "autosnippet" }, { t("\\sec") },
		{ condition = tex.in_mathzone }),
	s({ trig = "csc", dscr = "Csc function", snippetType = "autosnippet" }, { t("\\csc") },
		{ condition = tex.in_mathzone }),
	s({ trig = "asin", dscr = "Arcsin function", snippetType = "autosnippet" }, { t("\\arcsin") },
		{ condition = tex.in_mathzone }),
	s({ trig = "acos", dscr = "Arccos function", snippetType = "autosnippet" }, { t("\\arccos") },
		{ condition = tex.in_mathzone }),
	s({ trig = "atan", dscr = "Arctan function", snippetType = "autosnippet" }, { t("\\arctan") },
		{ condition = tex.in_mathzone }),
	s({ trig = "acot", dscr = "Arccot function", snippetType = "autosnippet" }, { t("\\arccot") },
		{ condition = tex.in_mathzone }),
	s({ trig = "asec", dscr = "Arcsec function", snippetType = "autosnippet" }, { t("\\arcsec") },
		{ condition = tex.in_mathzone }),
	s({ trig = "acsc", dscr = "Arccsc function", snippetType = "autosnippet" }, { t("\\arccsc") },
		{ condition = tex.in_mathzone }),
})
