...
Singleton {
    ...
    function applyHyprlandBorders(t) {
        ...
        hyprlandProc.command = ["sh", "-c", 'printf "general {\\n    col.active_border = ' + active + '\\n    col.inactive_border = ' + inactive + '\\n}\\n"' + ' > "$HOME/.config/hypr/theme-borders.conf" && ' + 'hyprctl keyword general:col.active_border "' + active + '" && ' + 'hyprctl keyword general:col.inactive_border "' + inactive + '"'];
