    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                // Theme count
                Text {
                    text: root.searchText !== "" ? root.filteredThemes.length + " of " + root.theme.count + " themes" : root.theme.wallpaperMode ? "Colors generated from current wallpaper" : root.theme.count + " themes — " + root.theme.currentFamily + " " + root.theme.currentName
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            Row {
                                ...
                                Repeater {
                                    model: [delegateRoot.modelData.data.bgBase, delegateRoot.modelData.data.accentPrimary, delegateRoot.modelData.data.accentGreen, delegateRoot.modelData.data.accentOrange, delegateRoot.modelData.data.accentRed]
